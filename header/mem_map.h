...
struct MemoryMap
{
	static constexpr uint16_t ROM_FIXED       = 0x3FFF;
	static constexpr uint16_t ROM_SWITCHABLE  = 0x7FFF;
	static constexpr uint16_t VRAM_BANK       = 0x9FFF;
	static constexpr uint16_t ERAM_BANK       = 0xBFFF;
	static constexpr uint16_t WRAM_FIXED      = 0xCFFF;
	static constexpr uint16_t WRAM_SWITCHABLE = 0xDFFF;
